...
### Base Policies
- `enterprise-base-policy.xml` - Foundation policy for Active Directory environments
- `non-ad-base-policy.xml` - Foundation policy for non-Active Directory environments (in non-AD directory)
